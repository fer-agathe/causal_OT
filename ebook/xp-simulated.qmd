...
Let us visualize the distribution on the individuals effects for each transport-based method, in @fig-xp-simul-indiv-effects (frequency on the y-axis).
```{r}
#| message: false
#| warning: false
