...
```{r}
#| code-fold: true
#| code-summary: Barycentric centroid of balance, when $\mathcal{D}(\boldsymbol{\alpha})$ with $\boldsymbol{\alpha}=(2, 5, 3)$ and when $\boldsymbol{p}=(3 ,2,1)/6$.
#| fig-cap: simplex-baryc-centr-bal-example
ggtern(
